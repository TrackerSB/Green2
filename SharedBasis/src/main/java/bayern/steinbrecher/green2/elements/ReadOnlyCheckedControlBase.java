...
/**
 * Represents a base implementation of {@link ReadOnlyCheckedControl} which can be used for delegation.
 *
 * @author Stefan Huber
 * @since 2u14
...
public class ReadOnlyCheckedControlBase<C extends Node> implements ReadOnlyCheckedControl {
     ...
     */
    public ReadOnlyCheckedControlBase(C control) {
