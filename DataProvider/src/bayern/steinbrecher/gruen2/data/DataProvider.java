...
public final class DataProvider {
    ...
    public static final ResourceBundle RESOURCE_BUNDLE
            = ResourceBundle.getBundle("bayern.steinbrecher.gruen2.data.language.language");
    /**
     * The default icon for stages.
     */
    public static final Image DEFAULT_ICON = new Image("bayern/steinbrecher/gruen2/data/resources/logo.png");
     ...
     * started.
     */
    public static final Image SPLASHSCREEN = new Image("bayern/steinbrecher/gruen2/data/resources/splashscreen.png",
            SPLASHSCREEN_PREFFERED_WIDTH, Double.MAX_VALUE, true, true);
    /**
     * The path of the file containing all stylings.
     */
    public static final String STYLESHEET_PATH = "bayern/steinbrecher/gruen2/data/resources/styles.css";
    /**
    ...
    public static final String APP_DATA_PATH = HOME_DIR + (CURRENT_OS == OS.WINDOWS
            ? "/AppData/Roaming/Grün2_Mitgliederverwaltung" : "/.Grün2_Mitgliederverwaltung");
    /**
    ...
    public static final String PROGRAMFOLDER_PATH_LOCAL = CURRENT_OS == OS.WINDOWS
            ? System.getenv("ProgramFiles").replaceAll("\\\\", "/") + "/Grün2_Mitgliederverwaltung"
     ...
     */
    public static final String GRUEN2_ZIP_URL = PROGRAMFOLDER_PATH_ONLINE + "/Gruen2.zip";
