...
public class QueryResultController extends WizardableController {
    ...
    @FXML
    private TableView queryResultView;
    ...
    public void setQueryResult(List<List<String>> queryResult) {
        ...
        //TODO Create ObservableList of ObservableList
        queryResultView.setItems(FXCollections.observableList(headings.subList(1, headings.size())));
    }
}
