...
jobject JNICALL Java_bayern_steinbrecher_green2_helper_Helper_00024HelperAction_install
(JNIEnv *jnienv, jclass clazz, jobject path, jstring message) {
    cout << "Install called" << endl;
...
jobject JNICALL Java_bayern_steinbrecher_green2_helper_Helper_00024HelperAction_uninstall
(JNIEnv *jnienv, jclass clazz, jobject path, jstring message) {
