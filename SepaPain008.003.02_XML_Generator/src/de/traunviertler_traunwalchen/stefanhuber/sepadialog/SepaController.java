...
import de.traunviertler_traunwalchen.stefanhuber.elements.CheckedTextField;
...
public class SepaController implements Initializable {
    ...
    private Eigeninfo eigeninfo = new Eigeninfo(DataProvider.getAppDataPath() + "/Eigeninfos.txt");
