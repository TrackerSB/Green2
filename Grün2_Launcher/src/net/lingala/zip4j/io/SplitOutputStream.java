...
public class SplitOutputStream extends OutputStream {
    ...
    /**
     * Checks if the buffer size is sufficient for the current split file. If
     * not a new split file will be started.
     *
     * @param bufferSize
    ...
    /**
     * Checks if the given buffer size will be fit in the current split file. If
     * this output stream is a non-split file, then this method always returns
     * true
     *
     * @param bufferSize
     * @return true if the buffer size is fit in the current split file or else
     * false.
     * @throws ZipException
     */
