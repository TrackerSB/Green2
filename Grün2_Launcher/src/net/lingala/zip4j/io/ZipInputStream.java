...
public class ZipInputStream extends InputStream {
    ...
    /**
     * Closes the input stream and releases any resources. This method also
     * checks for the CRC of the extracted file. If CRC check has to be skipped
     * use close(boolean skipCRCCheck) method
     *
     * @throws IOException
     */
