...
public class FileHeader {
    ...
    /**
     * Extracts file to the specified directory using any user defined
     * parameters in UnzipParameters
     *
     * @param zipModel
     * @param outPath
    ...
    /**
     * Extracts file to the specified directory using any user defined
     * parameters in UnzipParameters. Output file name will be overwritten with
     * the value in newFileName. If this parameter is null, then file name will
     * be the same as in FileHeader.getFileName
     *
     * @param zipModel
     * @param outPath
     * @param unzipParameters
