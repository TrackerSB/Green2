...
//		}
     ...
     * @param type - type of elements to be present in the list (ex: File,
     * String, etc)
     ...
     * @throws ZipException - if input string is null. In case of any other
     * exception this method returns default System charset
     */
